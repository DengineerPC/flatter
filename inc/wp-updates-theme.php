...
new WPUpdatesThemeUpdater_930( 'http://wp-updates.com/api/2/theme', basename(get_template_directory()) );
*/

if( !class_exists('WPUpdatesThemeUpdater_930') ) {
    class WPUpdatesThemeUpdater_930 {
